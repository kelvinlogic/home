(function () {
    ...
    currencyMaster.$inject = ['lodash', "rx", '$modal', '$scope', '$stateParams', '$translate', 'currencyDataSvc', 'throttleValue'];
    /* @ngInject */
            ...
            $translate(toTranslate).then(function (translations) {
                ...
                var afterChangeCb = function(response) {
                    ...
                    if (changedCount > 0) {
                        ...
                        if (changedCount === 1 && currency) {
                            msgData.data = currency.name + " " + currency.abbreviation;
                        } else {
                ...
                if ($.SmartMessageBox) {
                    ...
                    if (currency) {
                        ...
                        content = _.string.sprintf(warningTemplate, {
                            action: actionPresent,
                            data: selectedCurrencies.length + " " + pageTitle.toLowerCase()
                        });
                    }
