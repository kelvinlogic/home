(function () {
    ...
    vatMaster.$inject = ['lodash', '$scope', '$translate', 'DTOptionsBuilder'];

    /* @ngInject */
    function vatMaster(_, $scope, $translate, DTOptionsBuilder) {
        ...
        function edit() {
            ...
            delete vm.selectedVat.isSelected;
            vm.selectedVats = [];
            vm.selectedVat = null;
        }
        ...
        function load() {
            ...
            $scope.$watchCollection(function () {
                ...
                if (newCollection.percentage) {
                    // Search on percentage field.
                }
            });
        }
        ...
        function toggleSelection(item) {
            var index = vm.selectedVats.indexOf(item);
