(function () {
    ...
    productBrandMaster.$inject = ['lodash', '$scope', '$translate', 'DTOptionsBuilder'];

    /* @ngInject */
    function productBrandMaster(_, $scope, $translate, DTOptionsBuilder) {
        ...
        function edit() {
            ...
            delete vm.selectedProductBrand.isSelected;
            vm.selectedProductBrands = [];
            vm.selectedProductBrand = null;
        }
        ...
        function toggleSelection(item) {
            var index = vm.selectedProductBrands.indexOf(item);
            item.isSelected = !item.isSelected;

            if (item.isSelected) {
                vm.selectedProductBrand = item;

                // If item isn't in the selected items array...
                if (index < 0) {
                    // add it.
                    vm.selectedProductBrands.push(item);
                }
            } else {
                // If item isn't in the selected items array...
                if (index > -1) {
