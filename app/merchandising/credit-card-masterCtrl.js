(function () {
    ...
    creditCardMaster.$inject = ['lodash', '$scope'];

    /* @ngInject */
    function creditCardMaster(_, $scope) {
...
//            vm.gridOptions.enableScrollbars = false;
            ...
            vm.gridOptions.onRegisterApi = function (gridApi) {
                ...
                gridApi.selection.on.rowSelectionChanged($scope, function (gridRow) {
                    var index = vm.selectedCreditCards.indexOf(gridRow.entity);

                    if (gridRow.isSelected) {
                        vm.selectedCreditCard = gridRow.entity;

                        // If element isn't in the selected elements array...
                        if (index < 0) {
                            // add it.
                            vm.selectedCreditCards.push(gridRow.entity)
                        }
                    } else {
                        // If element isn't in the selected elements array...
                        if (index > -1) {
