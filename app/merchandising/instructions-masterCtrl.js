(function () {
    ...
    instructionMaster.$inject = ['lodash', '$scope'];

    /* @ngInject */
    function instructionMaster(_, $scope) {
...
//            vm.gridOptions.enableScrollbars = false;
            ...
            vm.gridOptions.onRegisterApi = function (gridApi) {
                ...
                gridApi.selection.on.rowSelectionChanged($scope, function (gridRow) {
                    var index = vm.selectedInstructions.indexOf(gridRow.entity);

                    if (gridRow.isSelected) {
                        vm.selectedInstruction = gridRow.entity;

                        // If element isn't in the selected elements array...
                        if (index < 0) {
                            // add it.
                            vm.selectedInstructions.push(gridRow.entity)
                        }
                    } else {
                        // If element isn't in the selected elements array...
                        if (index > -1) {
