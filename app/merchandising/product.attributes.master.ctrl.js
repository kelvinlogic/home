(function () {
    ...
    productAttributeMaster.$inject = ['lodash', '$scope'];

    /* @ngInject */
    function productAttributeMaster(_, $scope) {
...
//            vm.gridOptions.enableScrollbars = false;
            ...
            vm.gridOptions.onRegisterApi = function (gridApi) {
                ...
                gridApi.selection.on.rowSelectionChanged($scope, function (gridRow) {
                    var index = vm.selectedProductAttributes.indexOf(gridRow.entity);

                    if (gridRow.isSelected) {
                        vm.selectedProductAttribute = gridRow.entity;

                        // If element isn't in the selected elements array...
                        if (index < 0) {
                            // add it.
                            vm.selectedProductAttributes.push(gridRow.entity)
                        }
                    } else {
                        // If element isn't in the selected elements array...
                        if (index > -1) {
